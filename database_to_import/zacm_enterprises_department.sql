...
INSERT INTO `department` VALUES ('10#3','ELECTRIAL','SELL ELECTRICAL ITEMS'),('20#3','FOOD','SELL FOOD ITEMS'),('30#3','CLOTHES','SELL CLOTHES'),('admin','admin','admin');
